...
export class PhotoService {
    getData() {
        return [
            {
                itemImageSrc: 'https://thumbs.dreamstime.com/z/almac%C3%A9n-de-ropa-55443014.jpg?w=992',
                thumbnailImageSrc: 'https://primefaces.org/cdn/primeng/images/galleria/galleria1s.jpg',
                alt: 'Description for Image 1',
                title: 'Title 1'
            },
            {
                itemImageSrc: 'https://thumbs.dreamstime.com/z/frente-de-la-tienda-de-ropa-de-la-ventana-de-la-tienda-de-la-moda-63352967.jpg?w=992',
